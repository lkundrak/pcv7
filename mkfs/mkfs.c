...
/*
printf ("s_isize = %i\n", sizeof (filsys.fs.s_isize));
printf ("s_fsize = %i\n", sizeof (filsys.fs.s_fsize));
printf ("s_nfree = %i\n", sizeof (filsys.fs.s_nfree));
printf ("s_free = %i\n", sizeof (filsys.fs.s_free));
printf ("s_ninode = %i\n", sizeof (filsys.fs.s_ninode));
printf ("s_inode = %i\n", sizeof (filsys.fs.s_inode));
printf ("s_flock = %i\n", sizeof (filsys.fs.s_flock));
printf ("s_ilock = %i\n", sizeof (filsys.fs.s_ilock));
printf ("s_fmod = %i\n", sizeof (filsys.fs.s_fmod));
printf ("s_ronly = %i\n", sizeof (filsys.fs.s_ronly));
printf ("s_time = %i\n", sizeof (filsys.fs.s_time));
printf ("s_tfree = %i\n", sizeof (filsys.fs.s_tfree));
printf ("s_tinode = %i\n", sizeof (filsys.fs.s_tinode));
printf ("s_m = %i\n", sizeof (filsys.fs.s_m));
printf ("s_n = %i\n", sizeof (filsys.fs.s_n));
printf ("s_fname = %i\n", sizeof (filsys.fs.s_fname));
printf ("s_fpack = %i\n", sizeof (filsys.fs.s_fpack));
printf ("===\nfilsys = %i\n", sizeof (filsys.fs));
*/
...
printf ("i_gid = %i\n", sizeof (dino.i_gid));
printf ("i_size = %i\n", sizeof (dino.i_size));
printf ("i_addr = %i\n", sizeof (dino.i_un.i_addr));
printf ("i_lastr = %i\n", sizeof (dino.i_un.i_lastr));
printf ("i_rdev = %i\n", sizeof (dino.i_un.i_rdev));
printf ("i_group = %i\n", sizeof (dino.i_un.i_group));
printf ("i_un = %i\n", sizeof (dino.i_un));
printf ("===\ninode = %i\n", sizeof (struct inode));
printf ("===\ndnode = %i\n", sizeof (struct inode) - (
	sizeof (dino.i_flag) +
...
struct dinode dino;
printf ("di_mode = %i\n", sizeof (dino.di_mode));
printf ("di_nlink = %i\n", sizeof (dino.di_nlink));
printf ("di_uid = %i\n", sizeof (dino.di_uid));
printf ("di_gid = %i\n", sizeof (dino.di_gid));
printf ("di_size = %i\n", sizeof (dino.di_size));
printf ("di_addr = %i\n", sizeof (dino.di_addr));
printf ("di_atime = %i\n", sizeof (dino.di_atime));
printf ("di_mtime = %i\n", sizeof (dino.di_mtime));
printf ("di_ctime = %i\n", sizeof (dino.di_ctime));
...
/*
printf ("\n------------------(%i)\n", ip->i_number);
printf ("dp->di_mode = 0x%08x\n", dp->di_mode);
printf ("dp->di_nlink = 0x%08x\n", dp->di_nlink);
printf ("dp->di_uid = 0x%08x\n", dp->di_uid);
printf ("dp->di_gid = 0x%08x\n", dp->di_gid);
printf ("dp->di_size = 0x%08x\n", dp->di_size);
printf ("dp->di_atime = 0x%08x\n", dp->di_atime);
printf ("dp->di_mtime = 0x%08x\n", dp->di_mtime);
printf ("dp->di_ctime = 0x%08x\n", dp->di_ctime);
*/
